...
import co.edu.unipiloto.estdatos.tallergen.mundo.Camisa.Etiqueta;
...
import co.edu.unipiloto.estdatos.tallergen.mundo.Computador.Marca;
...
public class Main {
    ...
    public void agregarCamisa() throws Exception {
        ...
        Etiqueta[] etiq = Etiqueta.values();
        
        for (int i = 0; i < etiq.length; i++) {
            System.out.println("[" + (i + 1) + "] " + etiq[i]);
        }
        int indice = Integer.parseInt(br.readLine());
        Etiqueta etiquetas = etiq[indice - 1];
        ...
        Producto camisa = new Camisa(talla, precio, etiquetas);
    ...
    public void agregarComputador() throws Exception {
       ...
       Marca[] marcas = Marca.values();
        ...
        System.out.println("¿Precio?");
        double precio = Double.parseDouble(br.readLine().replace(",", "."));
        Producto computador = new Computador(gama, precio, marca);
        int respuesta = casilleros.almacenar(computador);
         if (respuesta != -1) {
            System.out.println("La computadora ha sido almacenado en el casillero " + respuesta);
        } else {
            System.out.println("No hay casilleros disponibles para almacenar la compra");
        }
        System.out.println("::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::");
